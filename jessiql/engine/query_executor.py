...
class QueryExecutor:
    ...
    def __init__(self, query: QueryObject, target_Model: SAModelOrAlias):
        ...
        # Init related executors: QueryExecutor() for relations
        ...
        for relation in self.query.select.relations.values():
            ...
            self.related_executors[relation.name] = executor

    def for_relation(self, source_executor: QueryExecutor, relation: SelectedRelation):
